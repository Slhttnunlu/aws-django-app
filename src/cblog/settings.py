...
DATABASES = {
    'default': {
        ...
        'HOST': 'delta-db.chzf7ykadc4i.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'delta-capstone' # please enter your s3 bucket name
